...
public class RedisUtil {
    ...
    public void leftPushAll(String key, Object[] val) {

        redisTemplate.boundListOps(key).leftPushAll(val);
    }
    ...
    public Long hashIncr(String key ,String hkey){
        return redisTemplate.boundHashOps(key).increment(hkey,1);
    }
    ...
    public Set<Object> hgetKeyList(String key) {
